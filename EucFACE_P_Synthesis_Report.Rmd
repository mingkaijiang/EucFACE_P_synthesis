...
Method 2 has slightly higher C pools than method 1. But, method 1 is based on both height and diameter and based on Eucalyptus nitens, whereas method 1 is based on diameter information of P. radiata. Hence, here I adopted method 1. 
...
### 5.15 other aboveground litter P flux
``` {r, echo=FALSE, warning=FALSE, message = FALSE}
...
### 5.17 Understorey production P flux
``` {r, echo=FALSE, warning=FALSE}
...
### 5.18 Soil mineralization P flux
``` {r, echo=FALSE, warning=FALSE}
