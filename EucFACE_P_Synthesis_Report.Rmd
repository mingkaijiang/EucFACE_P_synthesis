...
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
    ...
    summary_table_c_pool_by_treatment[,2:7] <- round(summary_table_c_pool_by_treatment[,2:7], 1)
...
<br/>
<br/>
Now, I summarize all flux variables:
``` {r, echo = FALSE, warning=FALSE, message=FALSE} 
...
Next, I am plotting all the P budgeting variables. 
