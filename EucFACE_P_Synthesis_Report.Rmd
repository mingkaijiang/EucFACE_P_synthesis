...
Now, we need to compare the two estimates:
...
The general temporal pattern is similar, but the biomass size is different. 
...
Less priorities:
    ...
    - understorey P retranslocation coefficient verification
    - CH4 data
    - litter pool
