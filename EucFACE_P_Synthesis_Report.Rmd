...
``` {r sourcefile, echo=FALSE, message=FALSE, warning=FALSE}
...
``` {r leaflitter1, echo=FALSE, warning=FALSE}
...
``` {r frass, echo=FALSE, message=FALSE, warning=FALSE}
    ### calculate the variable
...
``` {r microbe, echo=FALSE, message=FALSE, warning=FALSE}
    ### calculate the variable
...
```
Data record for soil P concentration is look quite good. 
...
``` {r phosphate, echo=FALSE, message=FALSE, warning=FALSE}
    ### calculate the variable
...
# 4. Important concentration related calculations. 
### 4.1 Leaf P retranslocation coefficient
