make_understorey_litter_flux <- function(c_frac) {
    ...
    out <-df[,c("Start_date", "End_date", "Date", "Ring","understorey_litter_flux", "ndays")]
    colnames(out) <- c("Start_date", "End_date", "Date", "Ring", "understorey_litter_flux", "Days")
