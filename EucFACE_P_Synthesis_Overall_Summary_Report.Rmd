...
#### Canopy N pool
``` {r, echo=FALSE, fig.width = 7, fig.align="center", warning=FALSE, message=FALSE} 
    canopy_n_pool <- make_canopy_n_pool(p_conc=canopy_n_concentration,
                                        biom=canopy_biomass_pool)
    ### make the plot
    p <- ggplot(canopy_n_pool,
                aes(Date, canopy_n_pool, color=factor(Ring))) +   
            geom_point(size = 5) + geom_line() + 
...
``` {r, echo=FALSE, fig.width = 7, fig.align="center", warning=FALSE, message=FALSE} 
    ...
    p <- ggplot(frass_n_production,
                aes(Date, frass_n_production, color=factor(Ring))) +   
            geom_point(size = 5) + geom_line() + 
...
### 7.3 Canopy N retranslocation coefficient
