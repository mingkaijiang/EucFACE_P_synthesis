...
``` {r, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 7, fig.align="center"}
    ...
    coarse_root_c_pool <- make_coarse_root_pool(c_fraction, FACE_ring_area) 
...
### High priorities
    ...
    - Update PPT values using new leaf mass data (variable SLA)
    - Sapwood depth information is available on HIEv
...
### Known missing data
    ...
    - Canopy P conc. (currently only May data included - Kristine)
    - Root mortality estimates? (Juan)
