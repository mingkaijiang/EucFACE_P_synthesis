make_total_p_budgeting_variables_unbootstrap <- function() {
    #### This function calculates all P budgeting variables
    
    ### leaf p retranslocation coefficient
    source("programs/summary_variables/bootstrap/make_leaf_p_retranslocation_coefficient_bootstrap_new.R")
    leaf_p_retrans_coefficient <- make_leaf_p_retranslocation_coefficient_bootstrap_new()
    
    ### standing P stock
    ### summarize according to year - this ignores bark and twigs
    source("programs/summary_variables/bootstrap/make_overstorey_standing_p_stock_pred.R")
    ...
    source("programs/summary_variables/bootstrap/make_understorey_standing_p_stock_pred.R")
    ...
    source("programs/summary_variables/bootstrap/make_total_p_requirement_pred.R")
    total_p_requirement_table <- make_total_p_requirement_table_pred(summary_table_flux_by_treatment_bootstrap)
